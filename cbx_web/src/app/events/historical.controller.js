...
angular.module('conext_gateway.events').controller("historicalController", [
  ...
  function($scope, faultWarningService, $filter, $rootScope, moment, TIME_LOCAL_FORMAT, paginationService) {
    ...
    faultWarningService.getHistoricalWarnings().then(function(data) {
      var events = [];
