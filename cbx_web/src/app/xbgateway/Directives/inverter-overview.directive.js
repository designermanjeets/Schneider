...
angular.module('conext_gateway.xbgateway').directive("inverterOverview", ["imageClickService", "deviceStateSevice",
  function(imageClickService, deviceStateSevice) {
    return {
      restrict: "E",
      replace: true,
      templateUrl: "app/xbgateway/Directives/inverter.html",
      scope: {
        device: "=",
      },
