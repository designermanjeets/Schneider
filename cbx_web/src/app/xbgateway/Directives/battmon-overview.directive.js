...
angular.module('conext_gateway.xbgateway').directive("battmonOverview", ["imageClickService", "deviceStateSevice",
  function(imageClickService, deviceStateSevice) {
    return {
      restrict: "E",
      replace: true,
      templateUrl: "app/xbgateway/Directives/battmon.html",
      scope: {
        device: "="
      },
