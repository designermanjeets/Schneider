...
gulp.task('default', function() {
  runSequence( 'powerflow', 'copy', 'fonts', 'flip-strings', 'scripts', 'styles', 'lib', 'inject-html');
});
...
gulp.task('cloud', function() {
  runSequence('powerflow', 'copy', 'fonts', 'flip-strings', 'styles', 'lib', 'inject-cloud-html', 'webserver');
});
